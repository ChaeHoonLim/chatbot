...
const VOICES = {
    ...
    /* 
        comment: Add 'ko-kr female'
        date: 2018. 03. 08
        reference: https://docs.microsoft.com/en-us/azure/cognitive-services/speech/api-reference-rest/bingvoiceoutput
        by. chaehoon.lim        
     */
...
class BingSpeechClient {
    ...
    synthesize(text, locale = 'ko-kr', gender = 'female') {
    ...
    synthesizeStream(text, locale = 'ko-kr', gender = 'female') {
        return this.issueToken()
            .then((token) => {
            this.token = token;
            this.tokenExpirationDate = Date.now() + 9 * 60 * 1000;
